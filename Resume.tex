...
\begin{rSection}{Projects}
	...
	\begin{rSubsection}{Bitscoper Cyber ToolBox}{}{}{}
		\item A Flutter application consisting of TCP Port Scanner, Route Tracer, Pinger, File Hash Calculator, String Hash Calculator, Base Encoder, Morse Code Translator, QR Code Generator, Open Graph Protocol Data Extractor, Series URI Crawler, DNS Record Retriever, and WHOIS Retriever.
		\item Available on Microsoft Store, Google Play, GHCR, and Amazon ECR.
	\end{rSubsection}
	...
	\begin{rSubsection}{TeleChirkut}{}{}{}
		...
		\item Available on Microsoft Store, Google Play, and as a PWA. \\ \\ \\ % Gaps
	\end{rSubsection}
