...
\begin{rSection}{Experience}
	...
	\begin{rSubsection}{AkijBashir Group}{February 2025 - May 2025}{Flutter Developer (Information Technology Intern)}{Dhaka, Bangladesh}
		\item Developed multiple file upload and download mechanisms and implemented iOS compatibility for their employee support system application and a retailer campaign application.
